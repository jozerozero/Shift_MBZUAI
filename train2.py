...
# data
parser.add_argument('--path_train_data', type=str, default="/l/users/zijian.li/data/train/flair", 
                    help='Specify the path to the training data files directory')
parser.add_argument('--path_train_gts', type=str, default="/l/users/zijian.li/data/train/gt",
                    help='Specify the path to the training gts files directory')
parser.add_argument('--path_val_data', type=str, default="/l/users/zijian.li/data/dev_in/flair",
                    help='Specify the path to the validation data files directory')
parser.add_argument('--path_val_gts', type=str, default="/l/users/zijian.li/data/dev_in/gt",
...
def main(args):
    ...
    for batch_data in train_loader:
        ...
        inputs, label = batch_data["image"].to(device), batch_data["label"].type(torch.LongTensor).to(device)
        print(inputs.shape)
        count += 1
        print(count)
        # exit()
